...
class AppSettings(Base):
    ...
    rerank_candidate_pool: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    rerank_top_n: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    rerank_min_score: Mapped[Optional[float]] = mapped_column(sa.Float, nullable=True)
