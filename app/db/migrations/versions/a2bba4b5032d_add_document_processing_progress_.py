...
down_revision: Union[str, None] = '031d3e796cb8'
...
def upgrade() -> None:
    ...
    op.add_column('documents', sa.Column('processing_stage', sa.String(length=100), nullable=True,
                                         comment='Current processing stage (e.g., Chunking, Embedding 50/100)'))
    op.add_column('documents', sa.Column('progress_percentage', sa.Integer(), nullable=False, server_default='0',
