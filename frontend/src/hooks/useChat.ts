...
export function useChat(kbId: string) {
  ...
  const sendMessage = useCallback(
    async (
      ...
      rerankCandidatePool?: number | null,
      ...
      try {
        ...
        const request: ChatRequest = {
          ...
          rerank_provider: rerankProvider ?? undefined,
          rerank_model: rerankModel ?? undefined,
          rerank_candidate_pool: rerankCandidatePool ?? undefined,
          rerank_top_n: rerankTopN ?? undefined,
          rerank_min_score: rerankMinScore ?? undefined,
